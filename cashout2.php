<?php
	...
	$sql5 = mysqli_query($conn,"select credential.username,merchant_name,merchant_outlet_name from credential,merchant where merchant_id='$id' and credential.credential_id=merchant.credential_id");
...
<?php
	...
	if(isset($_POST['SubmitButton']))
	{
		...
		$sql3 = "insert into cashout_temp (merchant_id,jml_cashout,agen) values('$id','$subtract','$agen')";
