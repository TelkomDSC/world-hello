...
if($uname==NULL)
	...
	$dbname = "paybyqr";
		...
		if (!$result) 
		{
			...
			{
				echo "<table id='myTable' align='center'><tr><th>merchant_id</th><th>username</th><th>merchant_api_key</th><th>merchant_name</th><th>merchant_outlet_name</th><th>director_name</th><th>net_balance</th><th>gross_balance</th><th>cashout</th><th>histori</th></tr>";
				while($row = $result->fetch_assoc()) 
				{
					...
					echo "
						<tr>	
							...
							<td>
								<form action=histori_transaksi.php?data=".$row['merchant_id'].">
									<input type='submit' name='histori' value=".$row['merchant_id'].">
								</form>
							</td>
						</tr>
					";	
